...
if __name__=='__main__':
    ...
    flattened_df=json_df.select(col("company"),explode(col("employees")).alias("employee"))
    flattened_df.show()

    flattened_df.select(col("company"),col("employee.firstName").alias("emp_name")).show()